  ...
  return (
    <main className="bg-paper">
      ...
      <section className="py-10 px-6 max-w-3xl mx-auto">
        <p className="font-sans text-sage text-center leading-relaxed mb-10 max-w-xl mx-auto">
        ...
        {/* Future Home Fund */}
        <div className="bg-sunrise-pink/20 border border-sunrise-pink/40 rounded-lg p-8 text-center paper-lift mb-14">
        ...
        {/* Registry Cards */}
        <div className="max-w-100 mx-auto gap-6 mb-3">
          {REGISTRIES.map(({ name, description, href, cta }) => (
            <div
              key={name}
              className="bg-sage/10 rounded-lg p-8 border border-sage/20 flex flex-col paper-lift text-center"
            >
